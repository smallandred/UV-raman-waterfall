function [fitresult, gof] = MTOFit1(X, Y)
%CREATEFIT(X,Y)
%  Create a fit.
%
...
opts.MaxIter = 40000;
opts.StartPoint = [Y(219)*0.7 platform platform platform platform platform platform platform platform platform platform platform platform 1615 1605 1595 1574 1547 1518 1508 1479 1456 1427 1413 1377 1366 25 25 25 25 25 25 25 25 25 25 25 25 25];
